...
file = open("output/papers_with_references1.txt",'r')
...
file = open("output/papers1.txt",'r')
...
new = open("output/paper_without_references1.txt",'w')
...
print "done drawing"
# nx.write_pajek(G,"output/2100.net")
# nx.write_gml(G,"output/2100.gml")
