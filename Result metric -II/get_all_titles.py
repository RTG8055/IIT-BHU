...
paperids={}
papers=set()
with open("../output/sample35/papers35.txt",'r') as f:
	i=0
	for line in f:
		i+=1
		line = line.strip('\n|\r')
...
print c_names,i
new = open("output2/sample35/papers35_titles_journals.txt",'w')
# new3=open("output/sample3/paperids3_350_conf.txt",'w')
i=0
