...
with open("output/sample8/filtered_papers_titSim_or_avg.csv",'r') as f:
	i=0
	for line in f:
		i+=1
...
with open("output/sample8/papers_with_references8.txt",'r') as f:
...
new = open('output/sample8/filtered_papers_with_references8.txt','w')
i=0
