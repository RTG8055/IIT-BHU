...
# required_group_ids=['0271BC14'] #computer science
required_group_ids = ['052C8328'] # biology
groupno_parentID={}
groups={}
...
for j in [0,1,2,3]:
	...
	if(j==0):
		...
		new_group_ids = new_group_ids + groups["052C8328"]
	...
	# break
# print required_group_ids
new = open("biology_output/bio_fos_ids.txt",'w')
